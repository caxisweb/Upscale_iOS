...
//            minLabelTextSize = nsstring.size(attributes: [NSAttributedStringKey.zone: minLabelFont])
//            let stringsize: CGSize = self.lblRange.text!.size(withAttributes: [NSAttributedStringKey.font : UIFont.systemFont(ofSize: 13, weight: .semibold)])
...
//            maxLabelTextSize = nsstring.size(attributes: [NSAttributedStringKey.zone: maxLabelFont])
        }
    }
